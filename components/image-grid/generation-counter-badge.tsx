...
export function GenerationCounterBadge({
  ...
  return (
    <div
      className={cn(
        "inline-flex h-8 items-center gap-2 rounded-full border border-outline-variant/30 bg-surface-container-low px-3 text-xs leading-none font-medium tracking-[0.02em] text-on-surface-variant shadow-ambient",
        className
      )}
